...
const Header = () => {
    return (
        <header className="bg-primary dark:bg-primary h-[108px] flex items-center">
            <div className="container max-w-screen-xl mx-auto flex justify-between items-center gap-2">
                <div className="flex justify-center items-center">
                    <Image src={Logo} alt="logo" width={60} height={60} className="rounded-full"/>
                    <strong>TienDung</strong>
                </div>
